...
function About() {
  ...
  return (
    <div className='part2 w-[100%] bg-secondary'>
        ...
        {/* //rounded div */}
        <div className='hidden sm:flex roundedDivWrapper relative w-[100%] h-[100px]  overflow-hidden mt-[-3vw]  '>
            <div className='roundedDiv w-[150%] h-[450%] rounded-[50%] bg-secondary absolute left-1/2 -translate-x-1/2 '></div>
        </div>
